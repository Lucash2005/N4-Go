...
${levelHint}
例句體裁（重要）：
- N5/N4 字卡例句請優先使用丁寧體（です／ます）。例如「公園へ散歩に行く」宜改為「公園へ散歩に行きます」或更自然的「公園を散歩します」。
- 陳述句用「です／ます。」即可，不必改成「ですか」；只有真正疑問句才需要「か／ですか」。
- 若原文已是通順的辞書形／普通體，結論可寫「需修正」，並在建議例句給丁寧體替換；不要只批評「缺ですか」。
